...
#returns a template 
def return_template(usertemplate_name,var1,setion,setion2,rep,cnx,user,template):
...
def doit(req):
    ...
    if action_type=="makepage":
        if setion==""  or setion2=="":
            ...
            return HttpResponse(return_template(usertemplate_name,var1,setion,setion2,rep,try_to_connect(),user,tname ) )
